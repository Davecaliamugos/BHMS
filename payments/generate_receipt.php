...
if (isset($_GET['id'])) {
    ...
    if (!$data) { die("Payment record not found."); }
} else {
    die("Invalid Request");
}
?>
...
<head>
    ...
    <style>
        ...
        .receipt-box { max-width: 400px; margin: auto; border: 1px solid #eee; padding: 30px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.15); }
